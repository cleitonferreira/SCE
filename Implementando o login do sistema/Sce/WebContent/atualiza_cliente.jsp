<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%@ page import="java.util.List, br.com.sce.model.bean.Cidade" %>
      <jsp:useBean id="cliente" scope="request" class="br.com.sce.model.bean.Cliente"></jsp:useBean>
...
<div align="center">
	...
	<input type="hidden" name="cli_codigo" value="${param.cli_codigo}"></input>	
<table
		...
		<tr>
			...
			<%
				...
				for(Cidade cidade: cidades){
					out.println("<option value='"+cidade.getCid_codigo()+"' "+ 
							(cliente.getCidade().getCid_codigo() == cidade.getCid_codigo() ? "SELECTED" : "" )+" >"+cidade.getCid_nome());		
				}
			%>
			</select>
			</td>
		...
		<tr>
			<td>Cep</td>
			<td><input id="cep" name="cli_cep" style="height: 20px" value="${cliente.cli_cep}" maxlength="9" onkeydown="Mascara(this,Cep);"></input></td>
		</tr>
		<tr>
			<td>Cpf</td>
		...
		<tr>
			...
			<td><input id="datanasc" name="cli_datanasc" style="height: 20px" value="${cliente.dataNascimentoFormatada}" maxlength="10" onkeydown="Mascara(this,Data);" onkeypress="Mascara(this,Data);" onkeyup="Mascara(this,Data);"></input></td>
		</tr>
		<tr>
			<td>Data de Cadastro</td>
			<td><input id="datacad" name="cli_datacad" style="height: 20px" value="${cliente.dataCadastroFormatada}" maxlength="10" onkeydown="Mascara(this,Data);" onkeypress="Mascara(this,Data);" onkeyup="Mascara(this,Data);"></input></td>
		</tr>
		<tr>
			<td>Email</td>
		...
		<tr>
			...
			<td><input type="radio" name="cli_sexo" value="M" ${cliente.getCli_sexo() == 'M' ? 'checked' : ''}> Masculino<br>
			<input type="radio" name="cli_sexo" VALUE="F" ${cliente.getCli_sexo() == 'F' ? 'checked' : ''}> Feminino</td>
		...
		<td><input type="radio" name="cli_estadocivil" value="S" ${cliente.getCli_estadocivil() == 'S' ? 'checked' : ''}> Solteiro<br>
		<input type="radio" name="cli_estadocivil" VALUE="C" ${cliente.getCli_estadocivil() == 'C' ? 'checked' : ''}> Casado</td>
