...
<div align="center">
	<form id="form_cidade" action="SceControle" style="width:300px; border-width:thin; border-style:dashed; border-color:navy; color: #0080FF; font-size: 10px; font-family: Tahoma, Verdana, Arial, Sans-Serif"
	 >
	<h3>${mensagem}</h3>
	<input type="hidden" name="cmd" value="atualizarCidade"></input>
	<input type="hidden" name="cid_codigo" value="${param.cid_codigo}"></input>	
<table
		...
		<tr>
			<td>Nome</td>
			<td><input name="cid_nome" id="cid_nome" style="height: 20px" value="${cidade.cid_nome}" maxlength="30"></input></td>
		</tr>
		<tr>
			<td>Uf</td>
			<td><input name="cid_uf" id="cid_uf" style="height: 20px" value="${cidade.cid_uf}" maxlength="2"></input></td>
		</tr>
		<tr>
